...
export class PDFPage extends React.Component {
  ...
  renderPage(page) {
    ...
    // console.log("####################")
    // console.log(containerWidth + "        " + page.getViewport(DEFAULT_SCALE).width + "  "+ calculatedScale + "  " + scale)
